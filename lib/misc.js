...
CCDENTAL_CONVENIOS = function(letra) {
  var convenios = [
    { codigo: "S", nombre: "Sin convenio" },
    { codigo: "F", nombre: "F Promocional" },
    { codigo: "E", nombre: "E Promocional" },
    { codigo: "P", nombre: "Particular" },
    { codigo: "C", nombre: "C / Plan Total 70" },
    { codigo: "D", nombre: "D" }
  ];
  return letra ? convenios.find(function(r) { return r.codigo==letra }) : convenios;
};
