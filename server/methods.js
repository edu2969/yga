...
Meteor.methods({
    ...
    ActualizarFicha(ficha) {
        ...
        // Ficha anterior
        var anterior = ficha._id ? Fichas.findOne({
            _id: ficha._id
        }) : false;
        ...
        if (ficha.paciente && ficha.paciente.rut) {
            var paciente = Pacientes.findOne({
